...
I've also wondered about more memory based approaches. For example, instead of mutating instructions, have a mechanism to have the agent reflect on trajectories, and make those reflections retrievable for injection while the agent is running. [ReasoningBank](https://arxiv.org/abs/2509.25140) does something like this.
